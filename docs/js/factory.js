$(function(){
    ...
    $(window).on('scroll', function(){
        ...
        //.hajimeni #main height
        var hajimeniMainTop2 = $('.factory').find('.seisan2').offset().top+650;
        // console.log(hajimeniMainTop);
        ...
        var hajimeniMainTop3 = $('.factory').find('.seisan3').offset().top+650;
        // console.log(hajimeniMainTop);
        ...
        var hajimeniMainTop4 = $('.factory').find('.seisan4').offset().top+650;
        // console.log(hajimeniMainTop);
        ...
        var hajimeniMainTop5 = $('.factory').find('.seisan5').offset().top+650;
        // console.log(hajimeniMainTop);
        ...
        var hajimeniMainTop6 = $('.factory').find('.seisan6').offset().top+650;
        // console.log(hajimeniMainTop);
